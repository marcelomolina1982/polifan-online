...
// Esta etapa es histórica. Si el bloque CAS original todavía existe lo mejora
// con un reintento; si una etapa más nueva ya cambió esa lógica (por ejemplo el
// merge tolerante de clients), no debe romper el build ni revertirla.
...
if(app.includes(before)){
  ...
  console.log('v25.0.74 · reintento CAS aplicado')
}else{
  console.log('v25.0.74 · CAS ya fue actualizado por una etapa más nueva; se conserva sin bloquear build')
}
...
console.log('v25.0.74 FINALIZE OK · compatible con sincronización V2 más nueva')
