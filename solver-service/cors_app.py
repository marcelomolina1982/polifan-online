...
# Los endpoints /motor-definitivo/health y /motor-definitivo/svg ya vienen
# registrados desde extended_app (importado por nest_sparrow). No volver a
# declararlos aquí porque Flask rechaza endpoints duplicados y el worker no arranca.
