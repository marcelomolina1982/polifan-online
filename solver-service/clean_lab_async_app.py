...
def async_health():
    return jsonify(ok=True, asyncSolve=True, solver='best-effort-v4-batch-fill', directSvgBenchmark=True, jsonBenchmarkReplay=True, strategyBenchmark=True, residualSpaceDiagnostics=True, maxCandidatePool=120,
