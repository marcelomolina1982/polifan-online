...
export default function App(){
  ...
  {page==='dashboard'&&<Dashboard db={db} go={go}/>} {page==='operations'&&<OperationsHub db={db} onSave={saveData} go={go}/>} {page==='new'&&<OrderForm key={editingOrder?.id||'new'} db={db} onSave={saveOrderData} editing={editingOrder} clearEdit={()=>setEditingOrder(null)}/>} {page==='orders'&&<><DispatchPanel db={db}/><Orders db={db} onSave={saveData} onEdit={o=>{setEditingOrder(o);setPage('new')}}/><OrdersFinance db={db}/></>}
