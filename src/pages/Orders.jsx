  ...
  return `<section class="internal-order">
    ...
    <div class="internal-body">
      ...
      <div class="internal-kpis">
        ...
        <div class="qr-kpi"><small>CONTROL DEL PEDIDO</small><img src="${qrImageUrl(o)}" alt="QR"><span>ESCANEAR QR</span></div>
...
function purchaseDetailHtml(o){
  ...
  const mainLimit=24
  const main=all.slice(0,mainLimit)
  const extra=all.slice(mainLimit)
  const pieces=totalPieces(o)
